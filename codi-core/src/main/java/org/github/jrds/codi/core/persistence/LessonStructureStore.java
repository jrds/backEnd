...
public class LessonStructureStore
{
    ...
    public LessonStructureStore(UsersStore usersStore)
    {
        ...
        Set<User> learners2905 = new HashSet<>(Arrays.asList(usersStore.getUser("u1900"), usersStore.getUser("u1901"), usersStore.getUser("u1902"), usersStore.getUser("u1903"), usersStore.getUser("u1904")));
